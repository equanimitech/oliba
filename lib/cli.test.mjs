...
test('quiz.js accepts "18", " 18 " and "18,0" for data-answer="18"', async () => {
  ...
  for (const given of ['18', ' 18 ', '18,0', '18.0']) assert.equal(matches(given, '18', 0), true, `"${given}"`);
  for (const given of ['17', '180', '', '18 mois']) assert.equal(matches(given, '18', 0), false, `"${given}"`);
