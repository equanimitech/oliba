...
const SKILLS = "lull-n-learn active. Skills: /deep-lesson (map a topic), /teach (learn one piece), /study (retrieval; also answers the status-line cue), /config (settings, status line). Spaced repetition grounded in Scott Young's Ultralearning. Data: ~/.lull-n-learn/";
