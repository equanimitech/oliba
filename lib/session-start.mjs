...
const SKILLS = "oliba active. Skills: /oliba:syllabus (map a topic), /oliba:teach (learn one piece), /oliba:study (retrieval; also answers the status-line cue), /oliba:config (settings, status line). Spaced repetition grounded in Scott Young's Ultralearning. Data: ~/.oliba/";
